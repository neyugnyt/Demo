...
namespace Service.Auth
{
    public class AuthService : IAuthService
    {
        ...
        public ReturnMessage<UserDataReturnDTO> CheckLogin(UserLoginDTO data)
        {
            ...
            try
            {
                var account = _userRepository.Queryable()
                    .Where(a => !a.IsDeleted && a.Type == UserType.Admin && a.Username == data.Username && a.Password == MD5Helper.ToMD5Hash(data.Password)).FirstOrDefault();
